...
const mensajeExitoContenedor = document.getElementById('mensaje-exito-contenedor');

const mensajeExitoClickeable = document.getElementById('mensaje-exito-clickeable');


function mostrarFormulario() {

    if (mensajeExitoContenedor) {
        mensajeExitoContenedor.style.display = 'none';
    }
...
if (formulario) {
    formulario.addEventListener('submit', function(event) {
        ...
        if (mensajeExitoContenedor) {
            mensajeExitoContenedor.style.display = 'block';
        }
    });
}


if (mensajeExitoClickeable) {
    mensajeExitoClickeable.addEventListener('click', mostrarFormulario);
}